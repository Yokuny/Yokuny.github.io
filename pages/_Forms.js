    ...
    return (
        <form className="lg:w-60 w-72 flex justify-center flex-col bg-gray-800 rounded" action="http://localhost:3000/saveForm" method="POST">
            <fieldset className="px-3 py-4">
                ...
                <br />
                <input className="px-1 mb-4 w-52 text-sm leading-7 bg-gray-900 focus:bg-gray-800 duration-500 text-gray-600 rounded" id="formName" type="text" name="formName" required placeholder="type your full name" />
                <br className="mb-4"/>
                <label className="pl-2 mb-4 text-sm text-green-700 hover:text-green-600" for="formEmail">Email</label>
                <br />
                <input className="px-1 mb-4 w-52 text-sm leading-7 bg-gray-900 focus:bg-gray-800 duration-500 text-gray-600 rounded" id="formEmail" type="text" name="formEmail" required />
                <br className="mb-4"/>
