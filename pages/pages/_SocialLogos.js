...
export default function SocialLogos(){
    const socialLogos = [
        ...
        {src:'/instagram_animated.svg', alt:'instagram logo', link:'https://www.instagram.com/user09111996/', rotate:'transform hover:translate-y-6 hover:rotate-90 duration-500', key:"3"},
