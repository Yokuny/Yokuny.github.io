...
export default function HeartButton() {
    function imageChange(){
        const fieldImageCatch = document.getElementById('contentHeartLogo')
        console.log(fieldImageCatch);
        fieldImageCatch.innerHTML = `
    ...
    return(
        <>
            <div id='contentHeartLogo' className='h-auto'>
                <Image
                    onClick={imageChange}
